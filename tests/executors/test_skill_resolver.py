...
class SkillResolverTests(unittest.TestCase):
    ...
    def test_runtime_inferred_required_capability_is_descriptive_until_matching_phase(self) -> None:
        candidate = _candidate(
        ...
        self.assertEqual(result.status, "resolved")
        self.assertEqual(result.resolved_skill.capability_id, "runtime_external_execution")  # type: ignore[union-attr]
